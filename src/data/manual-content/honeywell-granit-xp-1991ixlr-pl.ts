 ...
 * Honeywell Granit XP 1991iXLR (wariant zasięgu XLR — Extra Long Range) po polsku.
 */
export const granitXp1991ixlrPl: PolishManual = {
  updatedAt: '2026-06-22',
  intro:
    'Najważniejsze informacje o obsłudze bezprzewodowego skanera przemysłowego Honeywell Granit XP 1991iXLR — wariantu o najdłuższym zasięgu odczytu (XLR, Extra Long Range) — po polsku, od pierwszego ładowania i baterii, przez bazę, parowanie Bluetooth i celowanie na oddalone kody, po konfigurację kodami, sygnalizację, konserwację i rozwiązywanie problemów.',
  sections: [
    {
      title: 'Granit XP 1991iXLR: czym jest wariant XLR',
      blocks: [
        { type: 'p', text: 'Granit XP 1991iXLR to **bezprzewodowy, ultrawytrzymały skaner ręczny** typu area-imaging, czytający kody **1D i 2D**. Jest przeznaczony do najtrudniejszych warunków magazynowych i przemysłowych. Łączy się ze światem przez **Bluetooth**, zasilany jest **wymienną baterią litowo-jonową** zabudowaną w rękojeści, a dane przekazuje do hosta przez **bazę ładująco-komunikacyjną (cradle)** lub bezpośrednio do urządzenia Bluetooth.' },
        { type: 'p', text: 'Oznaczenie **XLR (Extra Long Range)** wskazuje wariant optyki o **najdłuższym zasięgu odczytu w całej rodzinie 199xi**. To skaner stworzony do pracy z **dużych odległości** — pozwala odczytywać kody bez podchodzenia do nich, na przykład etykiety umieszczone wysoko na regałach magazynowych czy na paletach poza zasięgiem ręki. Zachowuje przy tym zdolność odczytu kodów z bliska, więc tym samym urządzeniem zeskanujesz zarówno kod tuż przy okienku, jak i kod znacznie oddalony.' },
    ...
    },
    {
      ...
      blocks: [
        { type: 'p', text: 'Bazy zapewniają zasięg radiowy do około **100 m (klasa 1) lub 10 m (klasa 2)** od skanera, zależnie od otoczenia. Skaner cały czas utrzymuje łączność z bazą, nawet gdy nie przesyła danych. Gdy traci łączność, jest **poza zasięgiem** — próba odczytu kodu kończy się wówczas sygnałem błędu, a baza może dodatkowo uruchomić alarm dźwiękowy (Out-of-Range Alarm; czas trwania i typ dźwięku ustawia się kodami). Po powrocie w zasięg skaner odtwarza łącze, co potwierdza pojedynczy sygnał.' },
    ...
    {
      title: 'Skanowanie i celowanie na duże odległości (XLR)',
      blocks: [
        ...
        { type: 'p', text: 'W wariancie **XLR** celownik rzutuje **pojedynczy jasny punkt wskazujący środek pola widzenia** — wystarczy wyśrodkować ten punkt na kodzie. Taki sposób celowania ułatwia trafienie w **oddaloną** etykietę: kierujesz punkt na kod znajdujący się daleko, na przykład wysoko na regale, i odczytujesz go bez podchodzenia ani podnoszenia towaru. Dzięki optyce dalekiego zasięgu XLR tym samym urządzeniem obsłużysz zarówno kody tuż przy okienku, jak i kody znacznie oddalone.' },
        { type: 'p', text: 'Pamiętaj, że na odległość i pewność odczytu wpływa wielkość oraz jakość kodu — większe i dobrze wydrukowane kody czyta się z dalszej odległości, a przy odczycie z dużego dystansu warto ustabilizować rękę i wycelować punkt dokładnie na środek kodu. Gdy kody znajdują się blisko siebie, włącz **centrowanie (Centering)**, aby skaner czytał tylko kod celowo wskazany wiązką.' },
      ],
    },
    {
      ...
      blocks: [
        ...
        { type: 'list', items: [
          '**Ręczny (spustowy)** — skaner czyta po naciśnięciu spustu i kończy po odczycie kodu lub zwolnieniu spustu; najlepszy do typowej pracy w dłoni, także przy odczycie oddalonych kodów;',
    ...
    },
    {
      ...
      blocks: [
        { type: 'p', text: 'Granit XP 1991iXLR obsługuje szeroki zestaw symbologii — kody liniowe **1D** (m.in. Codabar, Code 11, Code 128, Code 39, EAN/UPC, Interleaved 2 of 5), kody **2D** (np. QR Code, Data Matrix, PDF417, Aztec) oraz kody pocztowe.' },
