...
/**
 * Skrócona instrukcja Magicard 300 po polsku. Opracowana na podstawie User Guide 1.06
 * (public/instrukcje/magicard-300-ug-en.pdf). Linki wewnętrzne w składni [tekst](/sciezka)
 * renderuje ManualBlocks (strona) i ManualPdf (PDF).
 */
export const magicard300Pl: PolishManual = {
  updatedAt: '2026-09-11',
  intro:
    'Najważniejsze rzeczy z instrukcji drukarki Magicard 300 zebrane w jednym miejscu: gdzie ją postawić, jak wgrać sterownik w Windows i na Macu, jakie taśmy i karty do niej pasują, jak podłączyć ją do sieci, jak ją czyścić i co oznaczają kody błędów na wyświetlaczu.',
  sections: [
    {
      ...
      blocks: [
        {
          ...
          items: [
            ...
            '**Złącza:** USB 2.0 i Ethernet 10/100. Pod spodem gniazdo linki Kensington.',
            '**Zasilanie:** zasilacz 100–240 V, 90 W.',
            '**Systemy:** Windows 8.1, 10 i 11, Windows Server 2008–2016, macOS od 10.9, Linux.',
            '**Opcje:** koder pasków magnetycznych HiCo/LoCo (ISO 7811), znak wodny HoloKote (cztery wzory własne), druk dwustronny (w wersji Duo).',
          ],
        },
        {
          type: 'p',
          text: 'Cena i dostępność są na [karcie Magicard 300](/produkt/magicard-300). Wersja z naszej oferty to 300 Duo, z drukiem dwustronnym od razu. Wszystkie modele Magicard porównasz na [stronie marki](/drukarki-kart-magicard).',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'p',
          text: 'Zwykłe biuro w zupełności wystarczy. Kilka rzeczy ma jednak znaczenie dla jakości druku i żywotności głowicy:',
        },
        {
          type: 'list',
          items: [
    ...
    },
    {
      ...
      blocks: [
        { type: 'p', text: 'Z przodu jest wyświetlacz LCD z przyciskami i odbiornik na gotowe karty (70 sztuk). Z tyłu stoi podajnik na czyste karty (100 sztuk). Pod pokrywą znajdziesz:' },
        {
          type: 'list',
          items: [
        ...
        { type: 'p', text: 'Na panelu tylnym są trzy gniazda: zasilanie 24 V, Ethernet i USB 2.0.' },
      ],
    },
    {
      ...
      blocks: [
        { type: 'p', text: 'Przyciski pod wyświetlaczem prowadzą po dwóch menu. Menu użytkownika przydaje się na co dzień:' },
        {
          ...
          items: [
            ...
            '**More → Network Info** – adres IP, DHCP, maska, brama i adres MAC. Tu sprawdzisz, czy sieć działa.',
      ...
      blocks: [
        {
          ...
          ordered: true,
          items: [
            'Wejdź na magicard.com, w zakładce Support wybierz model 300, a potem Drivers and Downloads → Magicard Windows Printer Driver.',
      ...
      blocks: [
        {
          ...
          ordered: true,
          items: [
            'Na stronie wsparcia Magicard przy modelu 300 wybierz MacOS Printer Driver. Zobaczysz dwie ikony: jabłko (macOS) i pingwin (Linux).',
            ...
            'W Ustawieniach systemowych → Drukarki i skanery dodaj Magicard 300.',
          ],
        },
        {
          type: 'p',
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'p',
          text: 'Magicard 300 przyjmuje wyłącznie taśmy z oznaczeniem **MC**. Taśmy MB są do modelu 600, a MA1000K to taśmy jednokolorowe wspólne dla całej serii. Drukarka czyta znacznik RFID na rolce, więc po założeniu taśmy niczego nie ustawiasz w menu.',
        },
        {
          type: 'list',
          items: [
            '[MC300YMCKO](/produkt/magicard-tasma-ymcko-300-wydrukow-mc300ymcko-s) – kolor z warstwą ochronną, 300 kart. Podstawowa taśma do identyfikatorów ze zdjęciem.',
            'MC200YMCKO – ta sama taśma na 200 kart, dla mniejszych nakładów.',
            'MC250YMCKO (panele YMCKOK) – kolor z przodu i czarny z tyłu, 250 kart. Do druku dwustronnego.',
            '[MC600KO](/produkt/magicard-tasma-czarna-overlay-600-mc600ko-s) – czarny druk z warstwą ochronną, 600 kart. Do kart z samym tekstem i kodem.',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: true,
          items: [
            'W Urządzeniach i drukarkach kliknij Magicard 300 prawym przyciskiem → Preferencje drukowania → Printer Status. Musi być „connected”. Bez połączenia dalsze kroki nie zadziałają.',
            'Zamknij okno stanu. Ponownie prawym przyciskiem → Właściwości drukarki → zakładka Network → przycisk Ethernet.',
            'Zaznacz **Use Static Network settings** i wpisz adres IP, maskę i bramę z Twojej sieci. Producent zaleca stały adres dla drukarek sieciowych.',
            'Kliknij OK. Podłącz kabel LAN do gniazda z tyłu i wyłącz drukarkę z zasilania na chwilę, żeby przyjęła ustawienia.',
            'Po uruchomieniu sprawdź adres w menu: More → Network Info → IP Address.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'p',
          text: 'Nasza [Magicard 300 Duo](/produkt/magicard-300) drukuje dwustronnie od razu. Jednostronną wersję 300 rozszerza się kluczem elektronicznym, bez wizyty serwisu. Zamawia się go po zarejestrowaniu drukarki na stronie wsparcia Magicard (potrzebny numer seryjny z menu Serial Number): Your Account → rejestracja → Choose a Support option → Upgrade to double-sided → akceptacja warunków → Place Order. Po opłaceniu klucz przychodzi w formie elektronicznej do wgrania do drukarki.',
        },
        {
          type: 'p',
          text: 'Tak samo działa HoloKote, czyli własny znak wodny nadrukowany warstwą ochronną, na przykład logo szkoły albo firmy. Drukarka ma cztery miejsca na wzory. Zamówienie składa się z Preferencji drukowania: zakładka Printer → Printer Upgrade(s) → Order Holokote. Gotowy wzór (plik .jfif) wgrywa się przyciskiem Manage Holokote i przypisuje do jednego z czterech miejsc.',
        },
        {
          type: 'p',
