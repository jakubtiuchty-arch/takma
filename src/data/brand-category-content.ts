...
export const brandCategoryContent: Record<string, SubcategoryRichContent> = {
  'drukarki-etykiet-zebra': {
    ...
    buyingGuide: {
      ...
      items: [
        'Dzienny wolumen druku — do 1 000 etykiet/dzień wystarczy drukarka biurkowa (ZD220 od 639 zł, ZD421 od 1 472 zł). Przy 1 000–5 000 etykiet/dzień wybierz model przemysłowy (ZT231 od 2 551 zł, ZT411 od 5 132 zł). Praca w terenie lub magazynie bez stałego stanowiska? Drukarka mobilna ZQ serii 300–600.',
        ...
        'Rozdzielczość druku — 203 dpi to standard dla etykiet logistycznych i adresowych (kody 1D). 300 dpi zalecane do etykiet z kodami 2D (DataMatrix, QR) o rozmiarze poniżej 10 mm i tekstu poniżej 6 pkt. 600 dpi (ZT411, ZT610) do mikroetykiet elektronicznych, jubilerskich i farmaceutycznych.',
        'Prędkość druku — od 102 mm/s (ZD220, wystarczająca do 300 etykiet/dzień) przez 152–203 mm/s (ZD421, ZD621) do 356 mm/s (ZT411, ZT610). Przy 2 000+ etykiet dziennie różnica między 152 a 356 mm/s to ponad 30 minut oszczędności.',
        'Łączność i integracja — USB jest standardem we wszystkich modelach. Ethernet (LAN) to must-have przy pracy w sieci z WMS. Wi-Fi 802.11ac/ax umożliwia elastyczne rozmieszczenie drukarek. Bluetooth 5.0 w modelach mobilnych do parowania z terminalami. Link-OS zapewnia zdalne zarządzanie całą flotą z jednej konsoli.',
      ...
      items: [
        {
          ...
          text: 'Platforma Link-OS to największa przewaga Zebry nad konkurencją (Honeywell, TSC, SATO). Umożliwia zdalne aktualizacje firmware, monitorowanie stanu głowic, podgląd poziomu materiałów i konfigurację ustawień — dla setek drukarek jednocześnie, z jednej konsoli webowej. W firmie z 50+ drukarkami to oszczędność dziesiątek godzin pracy IT miesięcznie. Żaden inny producent nie oferuje tak zaawansowanego fleet managementu w standardzie.',
        },
        {
    ...
    faq: [
      {
        ...
        answer:
          'Ceny drukarek etykiet Zebra zaczynają się od 639 zł netto za model biurkowy ZD220d (termiczny bezpośredni). Drukarki biurkowe termotransferowe kosztują od 1 472 zł (ZD421t) do 1 944 zł (ZD621t). Modele przemysłowe zaczynają się od 2 081 zł (ZT111) i sięgają 8 950 zł (ZT620 wide-format). Ceny w TAKMA zawierają 15% marży od najlepszej ceny dystrybutorskiej i są aktualizowane codziennie na podstawie notowań hurtowych.',
      },
      {
        question: 'Jaka jest różnica między drukarką termiczną a termotransferową Zebra?',
        answer:
          'Drukarki termiczne bezpośrednie (modele z literą „d", np. ZD421d) drukują ciepłem bezpośrednio na papierze termicznym — nie wymagają taśmy, ale wydruk blaknie w 6–12 miesięcy. Drukarki termotransferowe (modele „t", np. ZD421t) używają taśmy barwiącej (ribbon) przenoszącej barwnik na etykietę — wydruk jest trwały latami, odporny na UV, wilgoć i chemikalia. Wybór zależy od przeznaczenia: etykiety kurierskie → termiczna, etykiety produktowe/magazynowe → termotransferowa.',
      },
      {
        question: 'Czy drukarka Zebra współpracuje z moim systemem WMS/ERP?',
        answer:
          'Tak — drukarki Zebra obsługują język ZPL II, który jest standardem branżowym wspieranym przez praktycznie wszystkie systemy WMS (SAP WM, Oracle WMS, Comarch WMS, Asseco WAPRO) i ERP (SAP, Microsoft Dynamics, Comarch ERP). Dodatkowo platforma Link-OS udostępnia REST API, sterowniki Windows/Linux/macOS oraz SDK dla Java, .NET i Androida. Integracja z polskimi systemami kurierskimi (InPost, DPD, DHL, GLS) jest natywna przez moduły druku etykiet.',
      },
      {
        question: 'Jak długo wytrzymuje głowica termiczna w drukarce Zebra?',
        answer:
          'Żywotność głowicy zależy od modelu i intensywności użytkowania. W drukarkach biurkowych (ZD220–ZD621) głowica wytrzymuje 50–100 km taśmy, co odpowiada 300 000–600 000 etykiet standardowych (100×50 mm). W modelach przemysłowych (ZT231–ZT620) żywotność wynosi 150–300 km (1–2 mln etykiet). Kluczowe czynniki wpływające na trwałość to: jakość etykiet (certyfikowane materiały wydłużają żywotność o 30–50%), regularna konserwacja i unikanie druku na suchej głowicy.',
      },
      {
        question: 'Którą drukarkę Zebra wybrać do małej firmy / e-commerce?',
        answer:
          'Dla małej firmy wysyłającej do 100 paczek dziennie rekomendujemy ZD230d (ok. 780 zł) — termiczną, prostą w obsłudze, z USB. Przy 100–500 paczkach dziennie lepszy będzie ZD421d (ok. 1 472 zł) z opcją Ethernetu i odklejaka. Jeśli oprócz etykiet kurierskich drukujesz też etykiety produktowe wymagające trwałości, wybierz model termotransferowy ZD421t. Wszystkie te drukarki obsługują etykiety 4-calowe kompatybilne z kurierami InPost, DPD, DHL, UPS i GLS.',
      },
      {
        question: 'Czy mogę drukować etykiety RFID na drukarce Zebra?',
        answer:
          'Tak — Zebra oferuje modele z wbudowanym encoderem RFID UHF: ZD621R (biurkowa), ZT411R i ZT421R (przemysłowe). Drukarki te jednocześnie drukują grafikę na etykiecie i programują chip RFID zawarty w inlay. Obsługują standardy EPC Gen2 / ISO 18000-63. Enkodowanie RFID jest kluczowe w logistyce (śledzenie palet), retail (inwentaryzacja RFID) i healthcare (identyfikacja próbek). Ceny modeli RFID są wyższe o ok. 2 000–4 000 zł od wersji standardowych.',
      },
      {
        question: 'Jak serwisować drukarkę etykiet Zebra?',
        answer:
          'Podstawowa konserwacja obejmuje: czyszczenie głowicy termicznej alkoholem izopropylowym co 1 000 etykiet, czyszczenie wałka dociskowego co tydzień, usuwanie pyłu z czujników mediów co miesiąc. Zebra dostarcza narzędzia diagnostyczne w PrintDNA (Print Touch, Visibility Services) do monitorowania stanu głowicy i przewidywania wymiany. W przypadku poważniejszych usterek — naprawy na poziomie komponentów realizuje serwis serwis-zebry.pl (autoryzowany Printer Repair Specialist). Oryginalne części zamienne (głowice, wałki, gilotyny) dostępne w TAKMA.',
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          'Ceny terminali mobilnych Zebra zaczynają się od 2 417 zł netto za model entry-level TC22 (Wi-Fi 6E, skaner SE4710) i 2 690 zł za TC27 (5G/LTE+GPS). Terminal w formie smartfona EM45 kosztuje od 2 951 zł. Modele flagowe z Wi-Fi 7 i AI: TC501 od 3 730 zł (5G) lub 5 688 zł (WiFi), TC701 ultra-rugged od 4 017 zł (5G). Terminale z klawiaturą: MC3400 od 4 561 zł, MC3300x od 5 779 zł. Seria premium: TC53 od 6 418 zł, TC58 od 6 751 zł, TC73 ultra-rugged od 7 044 zł. Flagowe MC9400 od 7 638 zł, MC9450 z 5G od 8 594 zł. Ceny w TAKMA zawierają 15% marży od najlepszej ceny dystrybutorskiej i są aktualizowane codziennie.',
      },
      {
        question: 'Jak długo Zebra aktualizuje system Android w terminalach mobilnych?',
        answer:
          'Zebra zapewnia aktualizacje bezpieczeństwa LifeGuard for Android przez 5–10 lat od premiery urządzenia. Konkretne gwarancje: TC22/TC27 — Android do v16. TC53/TC58/TC73/TC78 — Android do v16. TC53e/TC58e — Android do v17 (o generację dłużej). MC3400 — Android 14 do v18. MC9400/MC9450 — Android 14 do v17. TC501/TC701 — Android 15 do v19 (najdłuższe wsparcie w ofercie). Comiesięczne łatki bezpieczeństwa dostarczane są OTA (Over-The-Air) — aktualizacja całej floty bez fizycznego dostępu do urządzeń. To krytyczne w środowiskach wymagających zgodności z RODO, PCI DSS czy HIPAA.',
      },
      {
        question: 'Ile trzyma bateria w terminalu mobilnym Zebra?',
        answer:
          'Czas pracy zależy od modelu i pojemności baterii. TC22: 3 800 mAh (~10 h) lub 5 200 mAh (~14 h). TC53/TC73: 4 680 mAh (~12 h) lub 7 000 mAh (~18 h). TC501/TC701: 5 000 mAh (~12 h) lub 7 240 mAh (~16 h) z ładowaniem bezprzewodowym Qi. MC3400: 7 000 mAh (~14 h). MC9400: 7 000 mAh (~16 h) lub 5 000 mAh freezer (do -30°C). Wszystkie modele mają wymienną baterię hot-swap/warm-swap — wymiana w 5 sekund bez wyłączania urządzenia i utraty sesji WMS. Do pracy wielozmianowej planuj 2 baterie na terminal + stację ładowania 5-gniazdową.',
      },
      {
        question: 'Czy terminale Zebra są wodoodporne i wytrzymują upadki?',
        answer:
          'Tak — terminale Zebra przechodzą certyfikację MIL-STD-810H (standard wojskowy USA). Odporność na upadki: TC22/TC27 — 1,5 m na beton. TC53/TC58/TC53e/TC58e — 1,8 m (2,4 m z etui Rugged Boot). TC501 — 2,4 m (2,7 m z boot). TC73/TC78 — 3,05 m. TC701 — 3,66 m. MC3400 — 2,4 m. MC9400/MC9450 — 3,65 m (najwyższa klasa). Klasa ochrony IP65/IP67/IP68 zapewnia pełną pyłoszczelność i wodoodporność (zanurzenie w wodzie do 1 m na 30 minut). Test tumble: od 500 do 6 000 upadków z 0,5–1,0 m w bębnie obrotowym. Gorilla Glass Victus na ekranie (TC501/TC701).',
      },
      {
        question: 'Jak terminal mobilny Zebra integruje się z systemem WMS/ERP?',
        answer:
          'Terminal Zebra integruje się z systemem WMS/ERP na trzy sposoby: 1) DataWedge — wbudowane narzędzie konfiguruje skaner do wysyłania danych do dowolnej aplikacji Android (web, natywna, emulacja terminala) bez pisania kodu — ustawienia profilów skanera w GUI. 2) Enterprise Browser — zabezpieczona przeglądarka do aplikacji web-WMS (SAP ITSmobile, Oracle WMS, Comarch WMS, Asseco WAPRO) z pełną obsługą skanera i klawiatury. 3) SDK Zebra (EMDK) — natywne API dla Java/Kotlin/Xamarin do głębokiej integracji z aplikacjami custom. Obsługiwane systemy polskie: SAP WM, Comarch WMS, Asseco WAPRO, Simple WMS, Qguar WMS. Integracja z kurierami (InPost, DPD, DHL, GLS) natywna przez moduły druku etykiet.',
      },
      {
        question: 'Terminal mobilny Wi-Fi czy z 5G/LTE — co wybrać?',
        answer:
          'Wi-Fi (TC22, TC53, TC501, MC3400, MC9400): wystarczający gdy terminal pracuje wyłącznie wewnątrz budynku z siecią bezprzewodową — magazyn, sklep, szpital, fabryka. Niższy koszt urządzenia (o 200–1 000 zł mniej), brak kosztów karty SIM. 5G/LTE (TC27, TC58, TC58e, TC78, MC9450): konieczny dla pracowników terenowych — kurierzy, serwisanci, inwentaryzacja w terenie, yard management. Wyższy koszt + SIM (~30–50 zł/mies.). Reguła: jeśli terminal nigdy nie opuszcza budynku → Wi-Fi. Jeśli wyjeżdża w teren lub potrzebuje GPS → 5G/LTE. Wyjątek: TC501/TC701 w wersji 5G mogą być tańsze niż wersja WiFi (TC501 5G od 3 730 zł vs WiFi od 5 688 zł).',
      },
      {
    ...
    comparisons: [
      {
        ...
        content:
          'Zebra i Honeywell to dwaj najwięksi producenci skanerów kodów kreskowych, kontrolujący łącznie ponad 55% rynku globalnego. Zebra DS2208 (352 zł, gwarancja 5 lat) vs Honeywell Voyager 1472g (~380 zł, gwarancja 3 lata) — Zebra wygrywa ceną i gwarancją. DS4608 (PRZYM) vs Honeywell Hyperion 1950g (Adaptus) — w testach na trudnych kodach PRZYM dekoduje o 20–30% więcej. DS3608 vs Honeywell Granit 1980i — porównywalna wytrzymałość (IP67, upadki 2,4 m), Honeywell nieznacznie tańszy. DS9308 prezentacyjny vs Honeywell Solaris 7980g — Zebra szybsza (1 120 vs 1 000 skanów/s). Kluczowa różnica: Zebra oferuje DataCapture DNA (123Scan, SMS) w standardzie, Honeywell wymaga osobnej licencji na Remote MasterMind. Dla firm z ekosystemem Zebra (drukarki, terminale) — wspólna platforma zarządzania to decydujący argument.',
      },
      {
        title: 'Skanery Zebra vs Datalogic — ekosystem kontra cena',
        content:
          'Datalogic (QuickScan, Gryphon, PowerScan) to trzeci producent skanerów na świecie, pozycjonowany cenowo o 10–15% niżej od Zebry w segmencie budget. Datalogic QuickScan QW2520 (~300 zł) vs Zebra DS2208 (352 zł) — Datalogic tańszy o ~50 zł, ale z gwarancją 3 lata (vs 5 lat Zebra) i niższą szybkością dekodowania. Datalogic Gryphon GM4500 (bezprzewodowy) vs Zebra DS8178 — porównywalna funkcjonalność, Datalogic zazwyczaj tańszy o 5–10%. PowerScan PD9531 (ultra-rugged) vs Zebra DS3608 — Datalogic mocny w sektorze produkcyjnym z technologią DPM. Zebra wyróżnia się ekosystemem (DataCapture DNA, kompatybilność z drukarkami i terminalami) oraz najdłuższą gwarancją. Datalogic jest dobrym wyborem jako tańsza alternatywa do pojedynczych stanowisk.',
      },
      {
        title: 'Skaner ręczny (handheld) vs prezentacyjny (hands-free) — kiedy co wybrać?',
        content:
          'Skaner ręczny (DS2208, DS4608, DS3608): operator bierze do ręki, celuje i naciska spust. Zalety: precyzyjne celowanie na konkretny kod (ważne gdy produkty leżą blisko siebie), niższa cena (od 352 zł), uniwersalność (kasa + inwentaryzacja). Skaner prezentacyjny (DS9308, SP7208, MP7600): stacjonarny na ladzie, klient/operator przesuwa produkt przed oknem. Zalety: hands-free — operator ma wolne ręce do pakowania, oszczędność 1–2 s/transakcji, mniej zmęczenia nadgarstka. Wady: wyższa cena (od ~1 800 zł), wymaga więcej miejsca. Reguła: do 200 transakcji/dzień → handheld (DS2208). 200–500 → handheld na podstawce (DS4608). 500+ → prezentacyjny (DS9308) lub in-counter (SP7208). Supermarket z 1 000+ transakcji → MP7600 multi-plane.',
      },
      {
        title: 'Skaner przewodowy vs bezprzewodowy — TCO porównanie',
        content:
          'Przewodowy DS2208 (352 zł): TCO 5 lat = 352 zł + 0 zł (kabel USB w zestawie, 5 lat gwarancji) = 352 zł. Bezprzewodowy DS8178 (~1 100 zł): TCO 5 lat = 1 100 zł + stacja ładowania (~300 zł) + 1 wymiana baterii (~100 zł) = 1 500 zł. Różnica: 1 148 zł/stanowisko. Kiedy bezprzewodowy się opłaca? Gdy operator chodzi po sklepie/magazynie i potrzebuje swobody ruchu. Inwentaryzacja: bezprzewodowy oszczędza 30–50% czasu (brak plątania się w kablach). Przyjęcie towaru na rampie: bezprzewodowy konieczny (brak gniazdek USB). Kasa stacjonarna: przewodowy zawsze lepszy — niezawodny, tańszy, zero ładowania.',
      },
      {
        title: 'Skaner standalone vs terminal mobilny ze skanerem — co wybrać?',
        content:
          'Skaner standalone (DS2208, DS3608): dekoduje kod i wysyła go do komputera/kasy. Nie ma ekranu, nie wyświetla danych WMS, nie uruchamia aplikacji. Cena: 352–3 000 zł. Zaleta: prosty, niezawodny, tani, 5 lat gwarancji. Terminal mobilny ze skanerem (TC22, TC53, MC3400): komputer z Androidem + skaner + ekran + klawiatura. Uruchamia aplikację WMS, wyświetla instrukcje kompletacji, zbiera dane. Cena: 2 417–8 594 zł. Kiedy skaner: operator skanuje na kasie/stanowisku z komputerem (dane wyświetlane na monitorze PC). Kiedy terminal: operator pracuje mobilnie w magazynie i potrzebuje widzieć dane WMS na swoim urządzeniu. Hybryda: skaner CS6080 na palcu + terminal TC22 na pasku — skanowanie hands-free z dostępem do WMS na ekranie.',
      },
    ],
    howToSteps: [
      {
      ...
      },
      {
        ...
        text: 'Szkolenie operatorów (30 min): prawidłowy kąt i odległość skanowania, obsługa trybu hands-free/handheld, wymiana kabla USB/baterii, rozpoznawanie błędów (brak odczytu → sprawdź jakość kodu, wyczyść okno). Plan konserwacji: czyszczenie okna skanera IPA 70% co tydzień. Sprawdzenie kabla USB co miesiąc. Aktualizacja firmware co 6 miesięcy (123Scan). Gwarancja DS2208 = 5 lat bez dodatkowych kosztów. Serwis pogwarancyjny: TAKMA + serwis-zebry.pl.',
      },
    ],
  },
}
