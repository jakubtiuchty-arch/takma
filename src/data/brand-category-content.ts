...
export const brandCategoryContent: Record<string, SubcategoryRichContent> = {
  ...
  'tablety-honeywell': {
    ...
    expertAuthority: 'TAKMA jest autoryzowanym dystrybutorem tabletów Honeywell z 25-letnim doświadczeniem w branży AutoID. Wdrożyliśmy setki urządzeń w magazynach, centrach dystrybucji i sieciach handlowych. Oferujemy pełen cykl: dobór modelu, konfigurację MDM (SOTI, Intune), pre-staging flotowy, montaż doków na wózkach i szkolenie operatorów. Znamy mocne strony (FlexRange 10,7 m, 800 nit, hot-swap) i ograniczenia (Wi-Fi 5 w RT10, procesor N4200 w RT10W). W ofercie mamy również [tablety Zebra](/tablety-przemyslowe-zebra) — pomagamy wybrać optymalny tablet niezależnie od marki.',
    technicalDeepDive: `Zestawienie kluczowych parametrów i cen tabletów Honeywell (netto, marzec 2026):\n\n• **EDA10A** (entry-level, Android): 10,1" FHD 550 nit, Gorilla Glass 5. Snapdragon SM4350 Octa-Core 2,2 GHz. RAM 4/64 lub 8/128 GB. Skaner S0703 SR do ~50 cm. Bateria 8 000 mAh hot-swap (12+ h). Wi-Fi 6, BT 5.1, NFC, opcja 5G. IP65, drop 1,3 m (MIL-STD-810H). 674 g. Od **4 071 zł netto** — tablet do retailu, lekkiego magazynu i pracy terenowej.\n\n• **RT10A** (enterprise, Android, FlexRange): 10,1" WUXGA **800 nit** (najjaśniejszy w klasie). Snapdragon Octa-Core 2,2 GHz. RAM 4/32 lub 8/128 GB. **FlexRange N6803 dual-lens do 10,7 m**. Bateria 5 900/10 280 mAh hot-swap. Wi-Fi 5, BT 5.0, NFC, opcja 4G LTE + GPS. IP65, drop 1,2 m (MIL-STD-810G). 1 200 g. Dock RT10-EVD (10-60V, VESA). Od **11 229 zł netto** — tablet do magazynów high-bay, wózków widłowych i logistyki.\n\n• **RT10W** (enterprise, Windows, Intel x86): identyczna obudowa jak RT10A (800 nit, IP65). **Intel Pentium N4200** x86 (2,5 GHz burst). **8 GB RAM / 128 GB SSD**. FlexRange N6803 opcja. Wi-Fi 5, BT 5.0, Micro HDMI. **Windows 10 IoT LTSC 2021** (wsparcie do 2032, natywnie Win32/.NET/SCADA). 1 200 g. Od **12 024 zł netto** — jedyny tablet rugged Windows x86 poniżej 15 000 zł.`,
    tcoComparisons: [
      {
