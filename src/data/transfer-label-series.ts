...
export const transferLabelSeries: TransferLabelSeries[] = [
  ...
  /* ──────────────── 12. 8100T CRYOCOOL — kriogeniczna -196°C ──────────────── */
  {
    ...
    notRecommendedFor: [
      ...
      'Aplikacje wymagające certyfikatu UL — Cryocool nie ma UL (dla UL z taśmą 5095 wybierz Z-Xtreme 4000T lub Z-Ultimate 3000T White)',
    ...
    comparedWith: [
      ...
      { seriesSlug: 'z-ultimate-3000t-white', whenToChooseThis: 'Cryocool dla kriogeniki laboratoryjnej z odpornością gamma. Z-Ultimate 3000T White dla **trwałych oznaczeń przemysłowych** w temperaturze otoczenia (motoryzacja, elektronika, tabliczki znamionowe) z certyfikatem **UL Recognized Component**.' },
    ],
    faq: [
      ...
      { question: 'Jakie certyfikaty ma Cryocool?', answer: '8100T Cryocool jest **BPA-free i latex-free** — bezpieczny dla próbek biologicznych i procedur medycznych. Produkowany w ramach **ISO 9001** z 23-punktową kontrolą jakości Zebra. **Nie ma certyfikatu UL** (dla UL z taśmą 5095 wybierz Z-Xtreme 4000T lub Z-Ultimate 3000T White), ani standardowych atestów spożywczych (BfR, FDA dla żywności) — to materiał laboratoryjny, nie spożywczy.' },
