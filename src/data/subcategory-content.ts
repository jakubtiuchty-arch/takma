...
Cena drukarki to zwykle 20–40 % wydatków w trzy lata. Resztę pochłaniają etykiety (0,01–0,05 zł za sztukę), taśmy barwiące przy druku termotransferowym (0,005–0,010 zł na etykietę), głowica wymieniana po 50–100 km przebiegu, czyli co 12–36 miesięcy, oraz serwis. Chropowate etykiety papierowe skracają żywotność głowicy o 40–60 %, folie PP i PET ją wydłużają, a czyszczenie głowicy izopropanolem co 1 000–2 000 etykiet potrafi ją podwoić.`,
  ...
  'materialy-eksploatacyjne': {
    definition: {
      heading: 'Materiały eksploatacyjne do drukarek etykiet i drukarek kart',
      content: 'Materiały eksploatacyjne to wszystko, co drukarka zużywa w pracy: etykiety samoprzylepne (papierowe, foliowe, termiczne), taśmy barwiące, opaski identyfikacyjne, a w drukarkach kart taśmy YMCKO i monochromatyczne oraz same karty PVC. W trzyletnim koszcie posiadania drukarki etykiet stanowią 60–80%, więc ich dobór ma większy wpływ na budżet niż cena samej drukarki. Materiał dobrany do modelu drukarki daje czytelne kody, trwały nadruk i mniej przestojów z powodu zacięć albo zużytej głowicy. W TAKMA są etykiety, taśmy i opaski Zebra, taśmy do drukarek kart Zebra ZC i Magicard (Pronto100, 300, 600, Prima 8) oraz karty PVC i zbliżeniowe do obu marek drukarek.',
    },
    buyingGuide: {
      heading: 'Jak dobrać materiały eksploatacyjne do drukarki?',
      items: [
        ...
        'Krok 6: Drukarki kart — taśmę dobiera się do modelu drukarki, nie do karty: YMCKO do kolorowego druku jednostronnego, YMCKOK do dwustronnego, K albo KO do samego czarnego tekstu i kodów. Karty PVC 0,76 mm są wspólne dla Zebra ZC i Magicard, a karty zbliżeniowe wybiera się według czytników w firmie (Unique 125 kHz albo MIFARE i DESFire 13,56 MHz)',
      ],
    },
    expertAuthority: 'TAKMA jest autoryzowanym partnerem Zebra Technologies i sprzedaje drukarki kart Magicard, więc dobór materiałów zaczyna się od modelu drukarki, nie od katalogu. Zespół techniczny pomaga klientom B2B obniżyć koszt druku i dobrać materiał do zastosowania: od etykiet logistycznych, przez oznaczenia w chłodniach i laboratoriach, po identyfikatory pracownicze i legitymacje. Etykiety i taśmy pochodzą od producentów drukarek, więc pasują do czujników i nie skracają życia głowicy.',
    technicalDeepDive: 'System materiałów eksploatacyjnych Zebra opiera się na precyzyjnym dopasowaniu trzech elementów: etykiety, taśmy barwiącej i głowicy drukującej. Oryginalne etykiety Zebra mają kalibrowane przerwy (gap) i czarne znaczniki (black mark) zapewniające bezbłędne pozycjonowanie w drukarce. Taśmy barwiące Zebra są formułowane pod konkretne serie etykiet — np. taśma 2300 Wax jest zoptymalizowana pod Z-Perform 1000T, a 3200 Wax/Resin pod Z-Select 2000T. Użycie zamienników może skrócić żywotność głowicy nawet o 50% i spowodować problemy z czujnikiem gap/black mark.\n\nW drukarkach kart taśma jest przypisana do modelu: Zebra ZC100 i ZC300 mają wspólne taśmy, ZC350 osobne, a każdy model Magicard własne. Taśma YMCKO ma panele żółty, purpurowy, cyjan i czarny oraz warstwę ochronną, dlatego jedna kaseta to określona liczba kart, na przykład 300 przy YMCKO do Magicard 300 i 250 kart dwustronnych przy YMCKOK. Taśmy monochromatyczne (czarna, biała, srebrna, złota) wystarczają nawet na 1 000 kart. Prima 8 drukuje w technologii retransferowej: obraz powstaje na folii, którą drukarka wtapia w kartę, więc zestaw składa się z taśmy YMCK i folii retransferowej.',
    useCases: [
      ...
      { title: 'Identyfikatory i legitymacje', description: 'Drukarka kart Zebra ZC300 albo Magicard 300 z taśmą YMCKO i kartami PVC 0,76 mm: identyfikatory pracownicze, legitymacje szkolne i karty lojalnościowe. Do kontroli dostępu karty zbliżeniowe Unique albo MIFARE zadrukowane tą samą drukarką.' },
    ],
    uniqueInsights: {
      heading: 'Czego nie powie Ci konkurencja o materiałach eksploatacyjnych',
      items: [
        ...
        { title: 'Liczba wydruków na taśmie do kart to liczba kart jednostronnych', text: 'Taśma YMCKO na 300 wydruków daje 300 kart z kolorowym awersem. Przy kolorowym druku po obu stronach na jedną kartę schodzą dwa komplety paneli, więc wychodzi 150 kart. Jeśli rewers ma być czarno-biały, lepsza jest taśma YMCKOK z dodatkowym panelem czarnym: 250 kart dwustronnych z jednej kasety.' },
      ],
    },
    faq: [
      { question: 'Jaką taśmę kupić do drukarki kart?', answer: 'Taśma zależy od modelu drukarki: Zebra ZC100 i ZC300 mają wspólne taśmy, ZC350 osobne, a każdy model Magicard (Pronto100, 300, 600, Prima 8) własne. Do kolorowych identyfikatorów jednostronnych wybierz YMCKO, do dwustronnych YMCKOK, do samego czarnego nadruku K albo KO. Zestaw do Prima 8 to taśma YMCK i folia retransferowa.' },
      { question: 'Czy karty PVC pasują do każdej drukarki kart?', answer: 'Standardowe karty PVC 0,76 mm (format CR80) drukują wszystkie drukarki Zebra ZC i Magicard z oferty. Wyjątki to karty HoloPatch z polem na hologram, przeznaczone do Magicard, oraz karty samoprzylepne 0,40 mm, które nakleja się na grubsze karty zbliżeniowe zamiast drukować na nich bezpośrednio.' },
      { question: 'Jakie materiały eksploatacyjne potrzebuję do drukarki etykiet?', answer: 'To zależy od technologii druku: drukarka termiczna (DT) wymaga tylko etykiet termicznych, drukarka termotransferowa (TT) wymaga etykiet + taśmy barwiącej (ribbon). Sprawdź model drukarki i maksymalną szerokość mediów. Drukarki biurkowe (seria ZD) używają rolek fi25, przemysłowe (seria ZT) — fi76.' },
...
Przykładowa kalkulacja TCO (3 lata, flota 20 terminali TC52): urządzenia (6 000 zł × 20 = 120 000 zł) + baterie zapasowe (350 zł × 40 = 14 000 zł) + stacje ładowania 5-gniazdowe (3 500 zł × 4 = 14 000 zł) + etuia ochronne (200 zł × 20 = 4 000 zł) + MDM licencja roczna (50 zł × 20 × 3 = 3 000 zł) = łączny TCO ~155 000 zł, tj. ~215 zł/miesiąc/terminal. Dla porównania: smartfon konsumencki (1 500 zł × 20 = 30 000 zł) wymienia się co 12–18 miesięcy z powodu uszkodzeń → TCO 3 lata: 60 000–90 000 zł + koszty przestojów, utracone skanowania, brak MDM. Terminal enterprise jest tańszy w 3-letnim TCO mimo wyższej ceny zakupu.`,
  ...
  'drukarki-kart': {
    ...
    faq: [
      { question: 'Jakie drukarki kart znajdę w ofercie TAKMA?', answer: 'Mamy sześć modeli: [Magicard Pronto100](/produkt/magicard-pronto100), [Magicard 300 S Duo](/produkt/magicard-300), [Magicard 600 Duo](/produkt/magicard-600-duo), [Zebra ZC100](/produkt/zebra-zc100), [Zebra ZC300](/produkt/zebra-zc300) i [Zebra ZC350](/produkt/zebra-zc350). Do drukarek dobierzesz też taśmy i materiały do czyszczenia. Wszystkie sześć modeli z cenami, ocenami i kosztem jednej karty zestawiamy w poradniku [Jaka drukarka do kart plastikowych? Ranking i porównanie 2026](/poradnik/jaka-drukarka-do-kart-plastikowych).' },
      ...
      { question: 'Czy drukarka kart PVC zapisuje dane RFID?', answer: 'Tylko jeśli wybrana konfiguracja ma odpowiedni enkoder. Można nadrukować zdjęcie na zgodnej karcie RFID bez zapisywania danych w jej chipie. W ZC300 kodowanie jest opcją zależną od wariantu. Magicard 600 Duo ma wersję z enkoderem kart chipowych (3652-5023/S), która zapisuje m.in. karty MIFARE, DESFire i iCLASS; podstawowa 3652-5021/3 enkodera nie ma.' },
...
Akcesoria Zebra mają RÓŻNE Part Numbery nawet w obrębie tej samej serii — np. głowica ZD621d (P1112640-050) ≠ ZD621t (P1112640-240). Przed zamówieniem zawsze zweryfikuj wariant drukarki (d/t) i rozdzielczość (203/300 dpi).`,
    ...
    faq: [
      ...
      },
      {
        ...
        answer: 'Tak, w dwóch odmianach. Wewnętrzna montuje się w drukarce: nawijak wewnętrzny do Zebra ZT610 i ZT620, nawijak podkładu do Zebra ZT410 i ZT411, nawijaki do Honeywell PM45 i PM65 oraz TSC MB241T i MH241T — wszystkie w tej kategorii. Zewnętrzna stoi obok drukarki i zwija gotowe etykiety w rolkę o średnicy większej, niż mieści drukarka; takich mamy dziewięć modeli w kategorii [nawijarki i odwijaki do etykiet](/nawijarki-do-etykiet).',
      },
    ],
    comparisons: [
      {
...
Tusze ColorWorks spełniają wymagania dla materiałów do kontaktu z żywnością, w tym rozporządzenie 1935/2004, rozporządzenie 10/2011, dobrą praktykę produkcyjną 2023/2006, wytyczne EuPIA oraz FDA CFR21. Na podłożach polipropylenowych etykiety chemiczne spełniają normę BS5609, wymaganą przy transporcie morskim substancji niebezpiecznych. Badanie CEC z listopada 2023 wykazało, że praca C4000e w pomieszczeniu czystym nie wpływa na jego certyfikację.`,
    ...
    faq: [
      {
        question: 'Jaka drukarka do naklejek kolorowych?',
        answer: 'Do naklejek firmowych, produktowych i na opakowania — atramentowa drukarka etykiet z rolką samoprzylepną i gilotyną. Przy szerokości do 104 mm i kilkuset naklejkach dziennie wystarczy Epson ColorWorks C3500 od 5 653 zł netto, przy większej liczbie wzorów lepiej sprawdzi się C4000e z rozdzielczością 1200 dpi. Naklejki, które mają znieść wilgoć, tarcie albo słońce, wymagają tuszu pigmentowego, a nie barwnikowego.',
      },
      {
        question: 'Czy jest drukarka termiczna, która drukuje w kolorze?',
        answer: 'Nie ma. Drukarka termiczna przyciemnia warstwę czułą na ciepło i daje jeden kolor, a termotransferowa kładzie kolor taśmy, po jednym na przebieg. Pełną paletę w jednym przejściu drukuje tylko urządzenie atramentowe. Jeśli szukasz „kolorowej drukarki termicznej”, potrzebujesz atramentowej drukarki etykiet — w tej kategorii jest sześć modeli.',
      },
      {
    ...
    comparisons: [
      ...
      { title: 'Drukarka do naklejek kolorowych a drukarka etykiet — czy to to samo?', content: 'To samo urządzenie. „Naklejka” i „etykieta” znaczą w praktyce to samo: kawałek podłoża z klejem, który przykleja się na produkt, opakowanie albo półkę. Producenci i sklepy używają obu słów wymiennie, a sprzęt się nie różni. Znaczenie mają trzy rzeczy, niezależnie od nazwy: szerokość rolki, powleczenie podłoża pod tusz i to, czy na wyjściu jest gilotyna, czy odklejak. Jeśli szukasz drukarki do naklejek kolorowych na słoiki, butelki albo opakowania, patrz na te parametry, a nie na nazwę kategorii w sklepie.' },
      { title: 'Drukarka termiczna kolorowa — dlaczego takiej nie ma', content: 'Druk termiczny polega na przyciemnianiu warstwy czułej na ciepło, więc z definicji daje jeden kolor, najczęściej czarny na białym. Druk termotransferowy przenosi barwnik z taśmy i kładzie tyle kolorów, ile jest przebiegów z różnymi taśmami — jeden na raz, bez zdjęć i przejść tonalnych. Pełny kolor w jednym przejściu daje wyłącznie druk atramentowy. Dlatego „drukarka termiczna kolorowa” to w praktyce atramentowa drukarka etykiet: szuka się jej pod tą nazwą, a kupuje urządzenie takie jak ColorWorks.' },
  ...
  'etykiety-do-kolorowych-drukarek': {
    ...
    useCases: [
      ...
      { title: 'Bilety na koncert', description: 'Papier Premium Matte Ticket 80 mm × 50 m, gilotyna odcina każdy bilet z kolorową grafiką i kodem.' },
      { title: 'Etykiety o zmiennej długości', description: 'Rolka ciągła Premium Matte 76 mm × 35 m do etykiet informacyjnych o różnej ilości tekstu, drukarka odcina je po wydruku.' },
    ],
    uniqueInsights: {
    ...
    faq: [
      ...
      { question: 'Czy rolki do C3500 założę w ColorWorks C6000?', answer: 'Nie. C6000 ma inną rodzinę nośników: rolki produkcyjne z 800–2310 etykietami, o innej średnicy i innym rdzeniu. Numery katalogowe do C6000 zaczynają się od C33S045722; rolki do C3500 mają numery z zakresu C33S045417–045543.' },
    ...
    comparisons: [
      { title: 'Premium Matte vs High Gloss', content: 'Premium Matte: matowy, tańszy, czytelny drobny tekst, do etykiet informacyjnych, logistycznych i produktowych bez zdjęć. High Gloss: błyszczący, droższy, głębsze kolory i zdjęcia, do etykiet produktowych na półkę.' },
      { title: 'Rolka ciągła vs wykrojona', content: 'Ciągła: jedna rolka do wielu formatów, etykieta odcinana gilotyną, brak odpadu między etykietami, ale rogi są proste, nie zaokrąglone. Wykrojona: gotowy format o równych, zaokrąglonych rogach, drukarka pilnuje pozycji, mniej ustawień w programie.' },
    ],
    howToSteps: [
  ...
  'dyspensery-etykiet': {
    ...
    comparisonTable: {
      ...
      rows: [
        { model: 'LD-115-RS', href: '/produkt/labelmate-ld-115-rs', role: 'Podstawowy wybór do 115 mm', cells: ['do 115 mm', 'od 6 mm', 'Papierowe i foliowe z nadrukiem', '223 × 305 mm'] },
        { model: 'LD-115-U', href: '/produkt/labelmate-ld-115-u', role: 'Gdy w asortymencie są etykiety przezroczyste', cells: ['do 115 mm', 'od 6 mm', 'Wszystkie, także przezroczyste i czarne', '223 × 305 mm'] },
        { model: 'LD-165-RS', href: '/produkt/labelmate-ld-165-rs', role: 'Szerszy materiał, etykiety papierowe', cells: ['do 165 mm', 'od 6 mm', 'Papierowe i foliowe z nadrukiem', '273 × 305 mm'] },
        { model: 'LD-165-U', href: '/produkt/labelmate-ld-165-u', role: 'Szerszy materiał, każdy rodzaj etykiety', cells: ['do 165 mm', 'od 20 mm', 'Wszystkie, także przezroczyste i czarne', '273 × 305 mm'] },
      ],
      note: 'Wszystkie modele wyposażono w trzon o średnicy 35 mm, przyjmujący gilze od 38 do 76 mm. Prędkość podawania jest regulowana w zakresie od 2,67 do 16,7 cm/s, klasa ochrony wynosi IP50, a gwarancja producenta obejmuje dwa lata, z rocznym okresem na zasilacz.',
    },
    buyingGuide: {
      heading: 'Jak dobrać dyspenser etykiet',
      items: [
        'Rodzaj etykiety przesądza o wersji. Wersja RS pracuje na czujniku odbiciowym i rozpoznaje etykiety papierowe oraz foliowe z nadrukiem. Etykieta przezroczysta albo czarna nie odbija światła w sposób, jakiego ten czujnik wymaga, wskutek czego urządzenie zatrzymuje się lub podaje dwie sztuki naraz. W takim procesie konieczna jest wersja U z czujnikiem fotoelektrycznym.',
        'Decyduje szerokość materiału, nie samej etykiety. Dyspenser prowadzi całą wstęgę wraz z podkładem. Modele 115 mm obejmują etykiety produktowe i apteczne, modele 165 mm — wysyłkowe oraz oznaczenia opakowań zbiorczych.',
        'Najkrótsza etykieta w asortymencie. Trzy modele rozpoznają etykiety od 6 mm długości, natomiast LD-165-U wymaga co najmniej 20 mm. Przy drobnych etykietach na fiolki albo próbki ta wartość rozstrzyga o wyborze modelu.',
        'Średnica i masa rolki. Wszystkie cztery modele przyjmują rolkę o średnicy do 220 mm i masie do 6 kg. Większy zapas wymaga wykonania XL na rolki do 300 mm, sprowadzanego na zamówienie.',
        'Średnica gilzy. Trzon o średnicy 35 mm przyjmuje gilze od 38 do 76 mm, a więc oba formaty stosowane w drukarkach etykiet. Zakup osobnych adapterów jest zbędny.',
        'Miejsce na stanowisku. Modele 115 mm zajmują 223 × 305 mm blatu, modele 165 mm — o pięć centymetrów więcej na szerokość. Urządzenie należy ustawić po tej stronie, z której operator pobiera etykietę.',
        'Warunki pracy. Klasa IP50 zapewnia ochronę przed pyłem, lecz nie przed zalaniem wodą. W wilgotnych strefach pakowania konieczne jest stanowisko osłonięte.',
      ],
    },
    expertAuthority: 'TAKMA prowadzi sprzedaż i serwis urządzeń do znakowania od ponad dwudziestu lat. Dyspensery trafiają najczęściej tam, gdzie etykieta powstaje na drukarce, a nakłada ją operator: do pakowni sklepów internetowych, na stanowiska kontroli jakości, do aptek i laboratoriów. Prosimy o kontakt z podaniem szerokości oraz najkrótszej długości etykiety, a także informacji, czy w asortymencie występują etykiety przezroczyste. Te trzy dane wystarczą do wskazania właściwego modelu.',
    technicalDeepDive: `Czujnik umieszczono pod wstęgą, gdzie wykrywa krawędź natarcia etykiety. W wersji RS jest to układ odbiciowy: nadajnik wysyła światło, a odbiornik mierzy jego natężenie po odbiciu. Papier odbija znaczną część wiązki, prześwit między etykietami wyraźnie mniejszą, i na tej różnicy opiera się rozpoznanie. Wersja U pracuje na układzie fotoelektrycznym, który mierzy przepuszczalność materiału zamiast jego połysku, dzięki czemu obsługuje również etykiety przezroczyste i czarne.

Regulacja ogranicza się do jednego pokrętła długości etykiety i zajmuje mniej niż pół minuty. Czujnik przesuwa się w poprzek wstęgi, dzięki czemu urządzenie obsługuje także etykiety o nietypowym kształcie oraz wstęgi, na których obok siebie biegną dwa pasy etykiet. Prowadnica materiału wchodzi w skład wyposażenia standardowego i utrzymuje wstęgę w osi.

Prędkość podawania reguluje się płynnie w zakresie od 2,67 do 16,7 cm/s. Ustawienie wolniejsze sprawdza się przy etykietach dużych i sztywnych, które przy szybkim podaniu mogą odskoczyć od czujnika. Szybsze — przy etykietach drobnych i wysokim tempie pakowania.

Osobną decyzją jest wybór między dyspenserem a odklejakiem wbudowanym w drukarkę. Odklejak pracuje wyłącznie w trakcie druku i wstrzymuje kolejny wydruk do czasu zdjęcia etykiety, przez co tempo pakowania zależy od tempa drukarki. Dyspenser działa niezależnie: rolkę można zadrukować wcześniej, całą serią, a etykiety wydawać w chwili, gdy produkt trafia na stanowisko. Przy pakowaniu partiami takie rozwiązanie jest zwykle wygodniejsze.`,
    useCases: [
      {
        title: 'Pakownia sklepu internetowego — 400 paczek dziennie',
        description: 'Etykiety produktowe drukowane są rano całą serią, a dyspenser wydaje je w tempie pakowania. Operator pracuje obiema rękami przy paczce i sięga po gotową etykietę. Wcześniej ta sama czynność wymagała odnalezienia narożnika na podkładzie i odspojenia go.',
        icon: 'logistyka',
      },
      {
        title: 'Kosmetyki — etykiety przezroczyste na butelkach',
        description: 'Etykieta ma pozostać niewidoczna na opakowaniu, dlatego materiał jest przezroczysty. Czujnik odbiciowy takiej etykiety nie rozpozna, więc na stanowisku pracuje wersja U z czujnikiem fotoelektrycznym.',
        icon: 'retail',
      },
      {
        title: 'Apteka i laboratorium — drobne etykiety na fiolki',
        description: 'Etykiety mają po kilkanaście milimetrów długości i trafiają na wąskie, okrągłe opakowania. Właściwy jest model rozpoznający etykiety od 6 mm, czyli LD-115-RS albo LD-115-U.',
        icon: 'produkcja',
      },
      {
        title: 'Produkcja — oznaczenia opakowań zbiorczych',
        description: 'Etykiety wysyłkowe o szerokości 150 mm przekraczają możliwości modelu 115 mm. Na stanowisku pracuje LD-165, a rolka o średnicy 220 mm starcza na całą zmianę.',
        icon: 'magazyn-wms',
      },
    ],
    uniqueInsights: {
      ...
      items: [
        {
          ...
          text: 'To najczęstsza przyczyna reklamacji w tej kategorii. Urządzenie pracuje bez zarzutu na etykietach papierowych, a po zmianie zlecenia na folię przezroczystą zaczyna podawać dwie sztuki naraz albo zatrzymuje się. Przyczyna tkwi w samej zasadzie działania czujnika, a nie w ustawieniu, wobec czego regulacja jej nie usunie.',
        },
        {
          title: 'Minimalna długość etykiety różni się między modelami tej samej serii',
          text: 'Trzy z czterech modeli rozpoznają etykiety od 6 mm, natomiast LD-165-U wymaga 20 mm. Przy asortymencie mieszanym, w którym obok etykiet wysyłkowych występują drobne oznaczenia, wybór szerszego modelu uniemożliwia obsługę tych najmniejszych.',
        },
        {
          title: 'Dyspenser nie zastępuje odklejaka w drukarce — rozwiązuje inny problem',
          text: 'Odklejak uzależnia tempo pakowania od tempa druku, ponieważ drukarka oczekuje na zdjęcie etykiety. Dyspenser pozwala zadrukować rolkę wcześniej i wydawać etykiety niezależnie. Przy pakowaniu partiami oznacza to dwie odmienne organizacje pracy.',
        },
        {
          title: 'Czujnik przesuwa się w poprzek wstęgi',
          text: 'Dzięki temu urządzenie obsługuje etykiety o nietypowych kształtach oraz wstęgi z dwoma pasami etykiet obok siebie. Jeden dyspenser pokrywa więc asortyment, który przy czujniku nieruchomym wymagałby dwóch ustawień albo dwóch urządzeń.',
        },
      ],
    },
    faq: [
      ...
      },
      {
        ...
        answer: 'Dyspenser odpowiada na inną potrzebę. Odklejak działa w trakcie druku i wstrzymuje kolejną etykietę do czasu zdjęcia poprzedniej, przez co tempo pakowania zależy od drukarki. Dyspenser pracuje niezależnie: rolkę można zadrukować wcześniej całą serią, a etykiety wydawać w tempie stanowiska.',
      },
      {
      ...
      },
      {
        ...
        answer: 'Poniżej trzydziestu sekund. Należy założyć rolkę, przeprowadzić wstęgę przez prowadnicę i ustawić jedno pokrętło długości etykiety. Przy zmianie na inny format regulacja ogranicza się do tego samego pokrętła.',
      },
      {
        question: 'Czy dyspenser obsłuży etykiety o nietypowym kształcie?',
    ...
    comparisons: [
      ...
      },
      {
        ...
        content: 'Wersja RS kosztuje około 350 zł mniej i w zupełności wystarcza, gdy wszystkie etykiety są papierowe albo foliowe z pełnym nadrukiem. Wersja U ma czujnik fotoelektryczny i rozpoznaje każdy rodzaj materiału. Jeżeli choćby jedno zlecenie w roku obejmuje etykiety przezroczyste, dopłata zwraca się już przy tym zleceniu.',
      },
      {
        title: 'Model 115 mm czy 165 mm?',
        verdict: 'Etykiety produktowe — 115 mm. Wysyłkowe i opakowania zbiorcze — 165 mm.',
        content: 'Szerszy model kosztuje około 220 zł więcej i zajmuje o pięć centymetrów więcej blatu. Warto go wybrać, gdy w asortymencie występują etykiety powyżej 115 mm; w przeciwnym razie nie wnosi żadnej korzyści. Należy przy tym pamiętać, że LD-165-U wymaga etykiet od 20 mm długości, podczas gdy pozostałe trzy modele rozpoznają je od 6 mm.',
      },
      {
        title: 'Dyspenser czy drukarka z odklejakiem?',
        verdict: 'Druk na bieżąco — odklejak. Druk partiami i pakowanie osobno — dyspenser.',
        content: 'Odklejak jest opcją w drukarce, zwykle za 300–600 zł, i działa wyłącznie podczas druku. Dyspenser stanowi osobne urządzenie za 2 100–2 700 zł, lecz uniezależnia wydawanie etykiet od drukowania. Gdy etykiety powstają rano całą serią, a pakowanie trwa przez cały dzień, odklejak nie spełni swojej roli: drukarka musiałaby pozostać włączona i oczekiwać na zdjęcie każdej etykiety.',
      },
    ],
    howToSteps: [
      ...
      { name: 'Pomiar szerokości wstęgi', text: 'Pomiarowi podlega cały materiał wraz z podkładem, nie sama etykieta. Do 115 mm wystarczy model mniejszy, powyżej tej wartości konieczny jest model 165 mm.' },
      { name: 'Sprawdzenie najkrótszej etykiety', text: 'Trzy modele rozpoznają etykiety od 6 mm, LD-165-U od 20 mm. Przy asortymencie obejmującym drobne etykiety ta wartość rozstrzyga o wyborze modelu.' },
      ...
      { name: 'Dobranie prędkości do stanowiska', text: 'Zakres regulacji wynosi od 2,67 do 16,7 cm/s. Etykiety duże i sztywne podaje się wolniej, aby nie odskakiwały od czujnika; drobne — szybciej, w tempie pakowania.' },
    ],
  },
