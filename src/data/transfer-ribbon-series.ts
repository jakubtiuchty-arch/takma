...
export const transferRibbonSeries: RibbonSeries[] = [
 ...
 faq: [
  ...
  { question: 'Jaka etykieta jest priorytetowa dla 3400?', answer: 'PolyE 3100T Gloss (polietylen) — to jest jej domyślne, pierwsze parowanie. Druga to 8000T All-Temp — gdy mróz łączy się z tarciem lub wilgocią w transporcie mroźniczym.' },
 ...
 recommendedForLabels: [
  ...
  { seriesSlug: '8000t-all-temp', seriesName: '8000T All-Temp', role: 'alternative', when: 'Wybierz gdy mróz łączy się z tarciem lub wilgocią (transport mroźniczy z przeładunkami). Do suchego chłodu na papierze All-Temp wystarcza standardowy wosk 2300 Wax.' },
 ],
 },
