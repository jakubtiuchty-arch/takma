...
export const thermalLabelSeries: ThermalLabelSeries[] = [
   ...
   * ──────────────────────────────────────────────────────────────── */
  {
    ...
    tagline: 'Powlekana etykieta z klejem gumowym do pełnego zakresu temperatur — trzyma do −40 °C w chłodni, z atestami żywnościowymi (BfR XIV, FDA, EC 1935/2004).',
    positioning: 'premium',
    ...
    heroIntro: 'Z-Select 2000D to flagowa etykieta termiczna Zebra z powłoką ochronną, drukowana bez taśmy barwiącej. Klej gumowy działa w pełnym zakresie temperatur — od **−40 °C do +50 °C** — więc etykieta trzyma się nawet w chłodniach i mroźniach. Powłoka ochronna daje ostry, czytelny kod kreskowy i chroni nadruk przed wilgocią i olejami. Ma komplet atestów do kontaktu z żywnością (BfR XIV, FDA 175.105, EC 1935/2004, EU 10/2011), dlatego jest standardem w sklepach, ochronie zdrowia i farmacji.',
    keyHighlights: [
   ...
   * ──────────────────────────────────────────────────────────────── */
  {
    ...
    tagline: 'Ekonomiczny niepowlekany papier do wysyłek, magazynu i kompletacji — najniższy koszt za metr.',
    ...
    heroIntro: 'Z-Perform 1000D to ekonomiczna, papierowa etykieta termiczna Zebra drukowana bez taśmy barwiącej — stworzona do codziennej pracy w magazynie, sklepie internetowym i logistyce. Matowy papier z trwałym klejem akrylowym wytrzymuje od **−20 °C do +80 °C**. Najniższy koszt za metr przy dużych nakładach etykiet wysyłkowych (InPost, DPD, DHL).',
    keyHighlights: [
   ...
   * ──────────────────────────────────────────────────────────────── */
  {
    ...
    badge: 'PolyPro 4000D',
    title: 'PolyPro 4000D',
    tagline: 'Wodoodporna folia polipropylenowa — naklejana nawet w −40 °C, z atestem FDA do pośredniego kontaktu z żywnością.',
    ...
    heroIntro: 'PolyPro 4000D to etykieta termiczna z matowej białej folii polipropylenowej zamiast papieru — **wodoodporna i odporna na rozdarcie**. Klej akrylowy pozwala nakleić ją nawet w **−40 °C**, więc świetnie sprawdza się w chłodniach, mroźniach i przy znakowaniu paczek. Ma atest FDA 175.105 do pośredniego kontaktu z żywnością — można ją naklejać na folię termokurczliwą i opakowania spożywcze. Dzięki odporności na rozrywanie nadaje się na pojemniki wielokrotnego użytku, skrzynki i regały, gdzie etykietę wymienia się razem z całością.',
    keyHighlights: [
   ...
   * ──────────────────────────────────────────────────────────────── */
  {
    ...
    tagline: 'Etykieta bez papierowego podkładu (linerless) z błyszczącym wykończeniem i klejem gumowym — bezfenolowa, do drukarek mobilnych i biurkowych Zebra.',
    ...
    heroIntro: 'ZeroLiner 2000D to etykieta **bez papierowego podkładu** (linerless) z błyszczącym wykończeniem i trwałym klejem kauczukowym — bezfenolowa, z wyższej półki. Brak podkładu oznacza więcej etykiet na rolce i mniej odpadów. Pracuje w zakresie **−10 °C do +60 °C**, zatwierdzona przez Zebrę do drukarek mobilnych i biurkowych — do handlu, magazynu i logistyki wewnątrz pomieszczeń.',
    keyHighlights: [
   ...
   * ──────────────────────────────────────────────────────────────── */
  {
    ...
    tagline: 'Etykieta bez papierowego podkładu (linerless) klasy podstawowej — do transportu, logistyki i poczty. Drukarki biurkowe, bezfenolowa, bez BPA i BPS.',
    positioning: 'linerless',
    material: 'papier-linerless',
    glue: 'permanentny',
    topcoat: true,
    ...
    heroIntro: 'ZeroLiner 1100D to podstawowa etykieta **bez papierowego podkładu** (linerless) zaprojektowana do typowego transportu i logistyki. Świetnie sprawdza się w biurkowych drukarkach Zebra przy niskich i średnich nakładach. Silikonowana powłoka wierzchnia chroni nadruk przed rozmazaniem i zarysowaniem. Jest bezfenolowa, bez BPA i BPS (zgodna z REACH, RoHS, EN71-3).',
    keyHighlights: [
   ...
   * ──────────────────────────────────────────────────────────────── */
  {
    ...
    tagline: 'Etykieta bez papierowego podkładu (linerless) z najwyższej półki, z klejem akrylowym — do druku dużych nakładów w trudnych warunkach. Pracuje do +100 °C.',
    positioning: 'linerless',
    material: 'papier-linerless',
    glue: 'permanentny',
    topcoat: true,
    ...
    heroIntro: 'ZeroLiner 4500D to najwyższej klasy etykieta **bez papierowego podkładu** (linerless) Zebry — niepowlekany papier z trwałym klejem akrylowym i błyszczącym wykończeniem, bezfenolowa. Stworzona do druku dużych nakładów i pracy w trudnych warunkach. Ma wyjątkowo szeroki zakres pracy **−10 °C do +100 °C** (po około dobie od naklejenia) — najszerszy w całej rodzinie ZeroLiner. Zalecana do drukarek przemysłowych i biurkowych Zebra.',
    keyHighlights: [
   ...
   * ──────────────────────────────────────────────────────────────── */
  {
    ...
    tagline: 'Z **klejem gumowym, który czysto się odkleja** i atestami żywnościowymi (BfR XIV, FDA). Do chłodni i mroźni — od −40 °C do +50 °C.',
    ...
    heroIntro: 'Z-Select 2000D Removable to etykieta termiczna Zebra z powłoką ochronną i **klejem gumowym, który czysto się odkleja — bez śladów** na podłożu. Powłoka ochronna zapewnia ostry nadruk i odporność na wilgoć, oleje i czynniki środowiskowe. Pracuje w zakresie **−40 °C do +50 °C**, a nakleić ją można już przy **−20 °C**, więc nadaje się do chłodni i mroźni. Ma komplet atestów do kontaktu z żywnością (BfR XIV, EC 1935/2004, EU 10/2011, FDA 175.105) oraz jest bez BPA i bez lateksu.',
    keyHighlights: [
   ...
   * ──────────────────────────────────────────────────────────────── */
  {
    ...
    tagline: 'Ekonomiczna, niepowlekana z **klejem, który czysto się odkleja** — bez BPA, z atestami do kontaktu z żywnością (FDA 175.105, EC 1935/2004). Zakres −10 °C do +70 °C.',
    positioning: 'zdejmowalna',
    material: 'papier-niepowlekany',
    glue: 'zdejmowalny',
    topcoat: false,
    ...
    heroIntro: 'Z-Perform 1000D Removable to papierowa etykieta termiczna Zebra z **klejem, który później czysto się odkleja — bez śladów** na podłożu. To wybór tam, gdzie etykieta jest tymczasowa, a powierzchnia ma zostać czysta. Matowy, biały, niepowlekany papier i zdejmowalny klej gumowy pracują w zakresie **−10 °C do +70 °C** (naklejać od **+5 °C**). Materiał jest bez BPA, a klej ma atest ISEGA i jest zgodny z normami kontaktu z żywnością suchą i nietłustą (EC 1935/2004, EU 10/2011, FDA 175.105).',
    keyHighlights: [
   ...
   * ──────────────────────────────────────────────────────────────── */
  {
    ...
    tagline: 'Papierowa przywieszka bez kleju do archiwizacji — nadruk czytelny do 5 lat wewnątrz, a **w warunkach archiwalnych nawet 12 lat**. Odporna na blaknięcie, bez BPA.',
    ...
    heroIntro: 'Z-Perform 1000D 110 Tag to papierowa **przywieszka bez kleju**, drukowana termicznie bez taśmy barwiącej. Sztywny, matowy biały papier dobrze trzyma nadruk i jest odporny na blaknięcie. Przy prawidłowym druku, obsłudze i przechowywaniu **nadruk pozostaje czytelny nawet przez 12 lat**, dlatego przywieszka nadaje się do archiwizacji. Materiał jest bez BPA.',
    keyHighlights: [
   ...
   * ──────────────────────────────────────────────────────────────── */
  {
    ...
    tagline: 'Podstawowa etykieta powlekana — powłoka ochronna dla lepszego nadruku, niski koszt jednostkowy.',
    ...
    heroIntro: 'Z-Essentials 1000D to papierowa etykieta termiczna Zebra z ochronną powłoką wierzchnią i trwałym klejem akrylowym — zaprojektowana do krótkoterminowych zastosowań o dużym nakładzie. Powłoka wierzchnia daje odporność na ścieranie, wilgoć i czynniki środowiskowe — pierwszy wybór do wysyłek ze sklepów internetowych, identyfikacji produktów, etykiet cenowych w sklepach i oznaczania prac w toku.',
    keyHighlights: [
   ...
   * ──────────────────────────────────────────────────────────────── */
  {
    ...
    heroIntro: 'Z-Essentials 500D to ekonomiczna, papierowa etykieta termiczna Zebra drukowana bez taśmy barwiącej — do dużych nakładów i krótkiego użytku. Niepowlekany, matowy papier z trwałym klejem akrylowym pracuje wewnątrz pomieszczeń w zakresie **0–40 °C**. To rozsądny wybór tam, gdzie liczy się koszt, a etykieta nie musi przetrwać długo: wysyłka, kompletacja, przyjęcia towaru, identyfikacja produktów i oznaczanie prac w toku.',
    keyHighlights: [
   ...
   * ──────────────────────────────────────────────────────────────── */
  {
    ...
    badge: '8000D Jewelry',
    title: '8000D Jewelry',
    tagline: 'Etykieta z folii polipropylenowej do biżuterii — powłoka UV, dobra odporność chemiczna, klej akrylowy. Pracuje od −40 °C do +49 °C.',
    positioning: 'specjalna',
    material: 'polipropylen-syntetyczny',
    glue: 'permanentny',
    topcoat: true,
    ...
    heroIntro: '8000D Jewelry to etykieta termiczna z białej folii polipropylenowej, stworzona do oznaczania biżuterii i drobnych elementów. Powlekana folia z powłoką UV jest znacznie trwalsza i bardziej odporna chemicznie niż papier, a trwały klej akrylowy trzyma w szerokim zakresie temperatur **od −40 °C do +49 °C**. Dobrze znosi rozmazywanie i zarysowania. Dostępna w **dwóch wersjach — ze skrzydełkami i bez skrzydełek**; skrzydełka owija się wokół drobnej biżuterii, żeby zmieściła się cała treść etykiety.',
    keyHighlights: [
