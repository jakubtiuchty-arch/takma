...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    href: '/skanery-kodow',
    children: [
      { name: 'Wszystkie skanery', href: '/skanery-kodow' },
      { name: 'Skanery przewodowe', href: '/skanery-przewodowe' },
      { name: 'Skanery bezprzewodowe', href: '/skanery-bezprzewodowe' },
      { name: 'Skanery prezentacyjne', href: '/skanery-prezentacyjne' },
    ],
  },
  {
    name: 'Materiały',
    ...
    children: [
      ...
      { name: '— WAX: 2300 Standard', href: '/tasmy-2300-wax' },
      { name: '— WAX: 2100 High Perf.', href: '/tasmy-2100-wax' },
      { name: '— WAX/RESIN: 3200 Premium', href: '/tasmy-3200-wax-resin' },
      { name: '— WAX/RESIN: 3400 HP', href: '/tasmy-3400-wax-resin' },
      { name: '— RESIN: 5095 HP', href: '/tasmy-5095-resin' },
