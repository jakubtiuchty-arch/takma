...
const SLUG = 'drukarki-etykiet-e-commerce'
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      images: ['/images/ecommerce.png'], title: page.seoTitle, description: page.seoDescription, url: `https://www.takma.com.pl/${page.slug}` },
