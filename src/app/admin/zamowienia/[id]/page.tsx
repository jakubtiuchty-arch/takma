    ...
    <div>
      <div className="flex items-center gap-3 mb-6">
        ...
        <a
          ...
          target="_blank"
          className="ml-auto inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50"
        >
