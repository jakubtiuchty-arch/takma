 ...
 * „Modele objęte promocją" na /promocje: wąski kafel, a urządzenie wychodzi
 * poza jego prawą krawędź.
 *
 * W mailu nie ma pozycjonowania (Gmail i Outlook wycinają position oraz ujemne
 * marginesy), więc nachodzenie składamy z dwóch kawałków zdjęcia: lewy siedzi w
 * komórce z ciemnym tłem, prawy w sąsiedniej na jasnym tle wiadomości. Pliki
