 ...
 * Newland (PN starts with N7-, NLS-, TPUN7, SPN7, BTY7) → prefix N1
...
function toIngramItemId(partNumber: string): string {
  ...
  // Newland products (terminals N7-*, accessories NLS-*, TPUN7*, SPN7*, BTY*)
  if (upper.startsWith('N7-') || upper.startsWith('NLS-') || upper.startsWith('TPUN7') || upper.startsWith('SPN7') || upper.startsWith('BTY7')) return 'N1' + upper
