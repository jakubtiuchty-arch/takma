...
function toIngramItemId(partNumber: string): string {
  ...
  if (upper.startsWith('CT7') || upper.startsWith('CT3') || upper.startsWith('CK') || upper.startsWith('EDA') || upper.startsWith('501') || upper.startsWith('2105') || upper.startsWith('2100') || upper.startsWith('1990') || upper.startsWith('1991') || upper.startsWith('1962') || upper.startsWith('1960') || upper.startsWith('1470')) return 'ON' + upper
