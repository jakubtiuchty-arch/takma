...
export async function middleware(request: NextRequest) {
  ...
  if (pathname.startsWith('/produkt/')) {
    ...
    const existingSlugs = new Set([
      ...
      'zebra-li3608-sr', 'zebra-li3608-er', 'zebra-ds3678-sr', 'zebra-ds3678-xr', 'zebra-ds3678-hd', 'zebra-ds3678-hp', 'zebra-ds2278', 'zebra-ds8288', 'zebra-ds4678', 'zebra-ds4678-dpe', 'zebra-ds9908',
      // Oprogramowanie
      'zebra-cardstudio',
    ])
