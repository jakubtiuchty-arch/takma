    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Content-Security-Policy', value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://lib.onet.pl https://*.posthog.com https://va.vercel-scripts.com https://challenges.cloudflare.com; style-src 'self' 'unsafe-inline'; img-src 'self' https: data:; font-src 'self' https://fonts.gstatic.com; connect-src 'self' https://*.posthog.com https://challenges.cloudflare.com https://va.vercel-scripts.com; frame-src https://challenges.cloudflare.com https://play.vidyard.com https://www.google.com; object-src 'none'; base-uri 'self'" },
